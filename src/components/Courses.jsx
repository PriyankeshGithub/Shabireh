...
const Courses = () => {
  return (
    ...
    <h1 className='classesText'>Classes we offer</h1>
      ...
      <Cards img={arabicLogo} title ="Arabic" desc="Arabic is a Semitic language primarily spoken in the Middle East and North Africa and is written in the Arabic script. It is the fifth most spoken language in the world and is also the liturgical language of Islam."/> </div></div>
      )
